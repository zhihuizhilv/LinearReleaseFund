...
//     // Pacific
//     let HarvestFactory = await ethers.getContractFactory("Harvest");
//     let harvest = await HarvestFactory.deploy(deployConfig.DMT);
//     await harvest.deployed();
//     deployResult.writeAbi("Harvest", HarvestFactory);
//     deployResult.writeDeployedContract(
//         "harvest",
...
async function deploy2() {
    ...
    harvest = await HarvestFactory.deploy(deployConfig.token);
    await harvest.deployed();
...
async function config() {
    ...
    const amounts = [
        ethers.utils.parseEther("7142857"),
        ethers.utils.parseEther("5619048"),
        ethers.utils.parseEther("9047619"),
        ethers.utils.parseEther("7142857"),
        ethers.utils.parseEther("10476190"),
        ethers.utils.parseEther("5238095"),
        ethers.utils.parseEther("7619048"),
        ethers.utils.parseEther("5619048"),
        ethers.utils.parseEther("2095238"),
        ethers.utils.parseEther("5714286"),
        ethers.utils.parseEther("9714286"),
        ethers.utils.parseEther("5714286"),
        ethers.utils.parseEther("1428571"),
        ethers.utils.parseEther("3571429"),
        ethers.utils.parseEther("1428571"),
        ethers.utils.parseEther("1428571"),
        ethers.utils.parseEther("714286"),
        ethers.utils.parseEther("714286"),
        ethers.utils.parseEther("5714286"),
        ethers.utils.parseEther("2857143"),
        ethers.utils.parseEther("2000000"),
        ethers.utils.parseEther("14666667"),
        ethers.utils.parseEther("5066667"),
        ethers.utils.parseEther("3333333"),
        ethers.utils.parseEther("3333333"),
        ethers.utils.parseEther("4666667"),
        ethers.utils.parseEther("11466667"),
        ethers.utils.parseEther("2666667"),
        ethers.utils.parseEther("11333333"),
        ethers.utils.parseEther("1333333"),
        ...
        ethers.utils.parseEther("6666667"),
        ethers.utils.parseEther("4285714"),
        ethers.utils.parseEther("2000000"),
        ethers.utils.parseEther("4857143"),
        ethers.utils.parseEther("7142857"),
        ethers.utils.parseEther("500"),
    ];

    console.log("begin add funder.");
    await (await harvest.addFunder(funders, amounts)).wait();
    console.log("add funder end.");
}
