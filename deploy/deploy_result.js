...
exports.writeTokens = function (tokens) {
  for (let symbol in tokens) {
    exports.writeToken(tokens[symbol][0], symbol, tokens[symbol][1])
  }
}

exports.writeToken = function (address, symbol, decimals, opts) {
  exports.writeDeployedContract("Token-" + symbol, ethers.utils.getAddress(address), "ERC20", {symbol: symbol, decimals: decimals, ...opts})
}
